...
def speak(text, speed=130, voice_id=default_voice_id):
    ...
    # Check if the engine's run loop is already running
...
def get_information():
    if request.method == 'POST':
        ...
        try:
            if 'hello' in query:
                speak("Hello, Good Day, welcome to MITCORER, How can i help you?")
...
def play_music(song_name=None):
    music_dir = "C:/Users/Rishu/Music"  # Update with your music directory path
